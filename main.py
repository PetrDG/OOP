...
first_student = Student("Роман", "Александров", "м")
first_student.finished_courses += ["Git"]
first_student.courses_in_progress += ["Python"]

second_student = Student("Илья", "Васильев", "м")
second_student.finished_courses += ["Git"]
second_student.courses_in_progress += ["JS"]


first_lecturer = Lecturer("Дмитрий", "Крупнов")
first_lecturer.courses_attached += ["JS"]
first_lecturer.courses_attached += ["Python"]

second_lecturer = Lecturer("Анна", "Красникова")
second_lecturer.courses_attached += ["Python"]
second_lecturer.courses_attached += ["JS"]

first_reviewer = Reviewer("Ксения", "Васильева")
first_reviewer.courses_attached += ["Python"]
first_reviewer.courses_attached += ["JS"]

second_reviewer = Reviewer("Оксана", "Александрова")
...
first_student.rate_lesson(second_lecturer, "Python", 5)
first_student.rate_lesson(second_lecturer, "Python", 7)
first_student.rate_lesson(first_lecturer, "Python", 9)
first_student.rate_lesson(first_lecturer, "Python", 10)
first_student.rate_lesson(first_lecturer, "JS", 7)
second_student.rate_lesson(first_lecturer, "JS", 10)
second_student.rate_lesson(first_lecturer, "JS", 10)
...
first_reviewer.rate_hw(second_student, "JS", 7)
first_reviewer.rate_hw(second_student, "JS", 7)
first_reviewer.rate_hw(second_student, "JS", 8)
...
print(f"Средняя оценка за ДЗ у Васильева больше, чем у Александрова {second_student < first_student}")
print(f"Средняя оценка за лекции у Красниковой меньше, чем у Крупнова {second_lecturer < first_lecturer}\n")


print(f'Средняя оценка студентов за курс JS: {average_rating_hw(student_list, "JS")}')
...
print(f'Средняя оценка лекторов за курс JS: {average_rating_lesson(lecturer_list, "JS")}')